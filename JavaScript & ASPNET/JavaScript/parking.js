export class parking {
    ...
    constructor(naziv, groundLevel, updateGarageStatus) {
        if (naziv) {
            this.naziv = naziv;
        } else {
            this.naziv = "Default";
        ...
        this.databaseData = "";
        this.updateGarageStatus = updateGarageStatus;
        this.listSpots = [];
            ...
            else
            {
                ...
                for (let j = 0; j < columns; j++) {
                    ...
                    else if (i != 0 && i != rows - 1 && j == columns - 1 && !this.groundLevel)
                    {
                        ...
                        var textNode = document.createTextNode(garaza.spotID); 
                        spotNumber.appendChild(textNode);

                        spot.setAttribute('id', garaza.spotID);
                        garaza.spotID++;
    ...
    async updateSpots() {
        ...
        this.listOfTakenSpots = [];
            ...
            // Koristi fetch funkciju da pošalje GET zahtev
            const response = await fetch('https://localhost:7138/api/Garage');
            ...
            // Postavljanje takenSpots unutar ovog bloka
            takenSpots = 0;
    ...
    openInfoBox(id){
        ...
        this.databaseData.forEach(result => {
        ...
        //parkedDate je kad je on parkiran
        //Pravi objekat od vreme
        ...
        this.editButton.addEventListener('click', (event) => {
            this.infoBoxDiv.remove();
            this.editVehicle(carId, brand, model, license, color, id, time);
    ...
    editVehicle(carId, brand, model, license, color, id){
